...
// Skip body parsing for auth routes (better-auth handles its own parsing)
...
app.use(skipAuthRoutes(express.json()));
app.use(skipAuthRoutes(express.urlencoded()));
...
// Returns detailed error only in development (based on NODE8ENV), otherwise a generic message
